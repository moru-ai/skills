---
name: moru-python
description: "Python SDK for Moru cloud sandboxes. Use when writing Python code that creates sandboxes, runs commands, handles files, uses volumes, or builds templates. Triggers on: 'moru python', 'from moru import', 'Sandbox.create', 'pip install moru', Python code execution in isolated environments."
---
