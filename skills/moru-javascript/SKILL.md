...
description: "JavaScript/TypeScript SDK for Moru cloud sandboxes. Use when writing JS/TS code that creates sandboxes, runs commands, handles files, uses volumes, or builds templates. Triggers on: 'moru javascript', 'moru typescript', '@moru-ai/core', 'Sandbox.create', 'npm install @moru', JS/TS code execution in isolated environments."
---
